...
function initMessageFormatSOAEP(packageRoot) {
    __unit( "RSAMessageFormatSOAEP_DIRECT.js" );
    __uses( "packages.js" );
    __uses( "Cipher.js" );
	...
	return SOAEP.create( random, cipherAlgorithm, false );
    }
 
    var RSAMessageFormatSOAEP = new RSAMessageFormat( factory );

    // export
    __export( this,"titaniumcore.crypto.RSAMessageFormatSOAEP_DIRECT", RSAMessageFormatSOAEP );
}
